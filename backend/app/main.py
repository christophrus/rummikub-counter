...
from app.services.orientation_detector import load_orientation_model
...
async def lifespan(app: FastAPI):
    ...
    # Orientierungserkennung laden (optional)
    if load_orientation_model():
        logger.info("✅ Orientierungs-CNN geladen.")
    else:
